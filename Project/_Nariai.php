...
// sužymėjus pakeitimus į _procNariai.php, bus dar perklausta
...
<html>
    ...
    <body>
		...
		<form name="vartotojai" action="_procNariai.php" method="post">
	    <table class="center" style="border-width: 2px; border-style: dotted;">
